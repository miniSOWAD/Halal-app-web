  ...
  return (
    <div className="auth-page page-shell">
      <form className="auth-card" onSubmit={submit}>
        <div className="auth-icon"><LogIn /></div><p className="eyebrow">Welcome back</p><h1>Sign in to HalalFit</h1><p className="muted">Save scans, favorites and reports across devices.</p>
        ...
        <p className="auth-switch">No account? <Link href="/register/">Create one</Link></p>
      </form>
    </div>
  );
}
